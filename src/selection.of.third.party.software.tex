...
this is an essential feature for our implementation. GreaseKit allows these
kinds of requests to take place, but we have not tested such support
extensively. We decided to focus all our efforts on one platform and thereby
not be subjected to cross-browser differences\dash{}both in potential bugs
...
\begin{items}
  ...
  \iterm{FastCGI} was the de facto way of running Ruby web applications
    ...
    \abbr{CGI} model. Contrasted to it's ancestor the processes
...
\sidenote{
  Available at \url{http://github.com/nkallen/screw-unit}.
}
...
\sidenote{
  These behaviour libraries ca be found at respectively
  \url{http://rspec.info},
...
and \project{Firebug}%
\sidenote{
  Available at \url{http://www.getfirebug.com}.
}.
