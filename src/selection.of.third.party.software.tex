...
\sidenote{
  According to \work{The TIOBE Programming Community Index}\dash{}a list of
  ...
  endorsing them\dash{}65.463 percent of the rated languages were object
  oriented \citep{tiobe08}.
  Some languages are multi-paradigm, but we've decided to
  count all languages that support object orientation as beeing object
  oriented. The languages counted towards object orientation were: Java, PHP,
...
and modules which easily can be integrated into a new software development.
...
finally \var{take back the Web}\dash{}making the decision of how a web page
