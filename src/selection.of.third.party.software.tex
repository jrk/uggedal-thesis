...
\sidetable[JavaScript Library Comparison]{%
           Comparison of JavaScript Library size
...
Since Hpricot is open source software someone had thankfully come across
...
large web sites and Facebook is currently the largest user of the open source
...
we used a Ruby library called \project{memcache-client}%
\sidenote{
  Available at \url{http://seattlerb.rubyforge.org/memcache-client/}.
}.

\subsubsection{Database Access Library}
...
% god. monitoring, process, memory, email notification, daemonization
...
\begin{figure}
  \begin{whole}
    \centering
    \includegraphics[width=0.85\wholewidth]{fig_prototype_architecture}
