...
implemented. It listens for requests on the \code{/hello/} path and takes the
directory name after this as a parameter. The parameter is then returned to
the requestor as a greeting:

\begin{scode}{Ruby}{hpricot}{%
  Greeting with Halcyon}{%
  A simple greeting application with Halcyon}
\begin{lstlisting}
...
% test this, does not currently work. The request is in JSON format. What
% about the data?
