...
navigational behaviour we've introduced additional confinements and decided to
only concentrate on browsing behaviour as detailed in
...
% Maybe it's okay to introduce it here and restate it in the background chapter
...
were presented to users who were participating in our study. We were able to
create a back end for the additional data and behavior our new functionality
required with the frameworks and programming language we found to be most
efficient in a prototypical process. This resulted in a transparent experience
for our end users as long as they had taken the necessary steps to set up the
browser extension and our script.
