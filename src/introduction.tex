...
community and there have been a handful of studies on it's applicabibity in
...
conciously in a web application design process.
...
of usefull social navigation techniques.
...
navigational improvments for the Norwegian Broadcasting Corporation's joint
TV, radio, and internet project: \emph{Urørt}--a service where artists upload
their demos and get valuable playtime on raido and TV if their products are
judged to be of sufficient quality. Our fucus is on the projects
...
Even though we've had an ongoing dialogue with the developers of Urørt we
...
web browser we were able to make changes and additions to the way Urørt were
presented to users who were participating in our study. We were able to create
a backend for the additional data and behaviour our new functionality required
...
users as long as they had taken the neccesary steps to set up the browser
...
\begin{description}
  ...
  \item[Transparent prototyping techniques] by highligting experiences from
