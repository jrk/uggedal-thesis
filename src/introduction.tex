...
infancy\dash{}is is bringing interesting innovations.
...
\sidenote{
  Collective intelligence is discussed in
...
\sidenote[-2\onelineskip]{%
  ...
  systems that have social characteristics look at
...
\sidenote{
  For more in depth coverage of our litterature collection method see
