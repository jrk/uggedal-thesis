...
decided on implementing is a so called \tarm{activity feed}. See
...
in addition to the methodology used for testing our prototype implementation
...
with a survey of the development software and tools we used in
