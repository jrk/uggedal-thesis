...
\sidenote[1]{
  ...
  \sectionref{social.navigation.sociality.the.social.web}.
}
...
This thesis are composed of two parts:
...
\begin{enum}
  ...
  \iterm{Unintrusive Prototypye of Social Navigation}. The second part starts
    with an account of how we created an unintrusive social navigation
    prototype before we go trugh an empirical study of the prototpe
    implementation.
\end{enum}
