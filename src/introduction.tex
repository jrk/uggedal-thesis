...
in \tablepageref{blog.usage} \citep[ch.~1, \p{6}]{rosa07}.
...
decided on implementing is a so called \term{activity feed}. See
\sectionref{analysis.facebook.news.feed} and
\sectionref{implementation.design.activity.feed}
...
methods and data \citep[\p{77}]{silverman05}.

% \section{Research Hypotheses}
%
% What to do? Place hypotheses here? I may need to use technical terms.
% Possibly better to state hypotheses and how they developed in the
% discussion chapter?
...
\begin{enum}
  ...
  \item Applicability of a particular social navigation technique
    by discussing findings from a experiment of its real world usage.
\end{enum}
...
in \chapterref{background}.


In \chapterref{methodology} we'll look at what methods we used in our
research.
The actual survey and analysis of the data we've collected from modern web
sites can be found in \chapterref{analysis}.
...
a social navigation technique can be found in \chapterref{discussion}.
