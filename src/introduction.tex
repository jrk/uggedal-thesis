...
\sidenote[-5]{
  \prequote{knuth07}{%
    also belives innovation in computer science is incremental:}{%
...
prototyping in \chapterref{background} and
look at what methods we've used for our research in
\chapterref{methodology}.
...
a social navigation technique
can be found in \chapterref{discussion}.
