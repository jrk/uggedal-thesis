...
\sidefill%
\sidenote{%
Keyword and citation search was conducted on the
ACM Digital Library
(Available at \url{http://portal.acm.org/dl.cfm}),
The Collection of Computer Science Bibliographies
(Available at \url{http://liinwww.ira.uka.de/bibliography/}),
Inspec Online
(Available at \url{http://web5s.silverplatter.com}),
and HCI Bibliography
(Available at \url{http://www.hcibib.org}).
}
Table~\ref{table:social.navigation.academia}
(p.~\pageref{table:social.navigation.academia}) shows the metrics of articles
we found about social navigation related to the web and other areas of
computer science (software development tools, security, and so on).
% need more examples of other contexts
%
% tagging is often written about, but social navigation is almost never
% mentioned. include this in the table and mention them?
% this kind of contradicts the next sentence
