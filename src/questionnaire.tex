...
The pre-installation questions were asked 24 hours after users were given
their initial survey and the option to install our prototype application.
...
%
% Create this so that I can send it out before Friday. Use the surveymonkey
% email sender so that I don't need to collect email adresses. Only send
% out to the 46+ actual users.
%
