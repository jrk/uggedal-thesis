...
\citeauthor{dieberger97} higlights an important aspect for making interaction
...
milennium was written by \citet{dieberger00b}. The article's discusses social
navigation in different kinds of coputer systems used on the Internet. It's
...
\sidenote{
  Uniform Resource Locator. URL was formerly an abbrivation of Universal
  Resource Locator.
}
...
oppinion enable more widespread use of social navigation trough pointer
