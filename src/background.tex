...
\subsubsection{Interaction History Sharing}
...
``Footprints'' system--an active navigational aid visualizing interaction
history of past users and enables current users to navigate this information.
...
theoretical computer system named the ``Memex''%
\sidenote{
  ...
  speed and flexibility. An integral part of this system a user' and content
  providers' ability to introduce trails between information items. 
  \citeauthor{bush45}'s writing about trails have in turn inspired hypertext.
}.
