...
\begin{enum}
  ...
  \item Using a content-based approach where one is relying on the nature of
    potential items instead of other people's perception of them.
...
% google adsense is a recommender system. very good example
