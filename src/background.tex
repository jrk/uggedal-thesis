...
recommendations for users that can give navigational possiblities.

\subsubsection{Recommendation Systems}
\label{section:background.social.navigation.applied.forms.recommendations}

A \term{recommendation system} is

What is then the difference between a collaborative
filtering system and a recommendation system?
Recommender systems are often based on collaborative
filtering principles. They then take advantage of the verdicts of users
that in some way are deemed to be similar to  yourself.
Another approach is to rely on the nature of items that are recommended
instead of other people's perception of them. Based on your previous usage
of items similar items can then be recommended\dash{}a asocial process.
This means that recommender
systems is a broader concept than collaborative filtering.
...
%
% google adsense is a recommendation system. very good example
