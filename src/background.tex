...
user interface which supported both search by key word and navigation by tag
...
information using  search by key word required fewer queries than using tag
...
by key word, needs to be in place for enabling efficient navigation.

%%
%% Read trough from here! Next title is a bit misleading as we've already
%% talked about navigation in the form of tag clouds. Maybe move it
%% before clouds? If clouds is not mentioned, that is.
%%

\subsubsection{Tagging as navigation}
...
\begin{sparkline}{3}
  ...
  \sparkspike .75  .74
\end{sparkline}
the authors interpret as evidence of a high degree of
