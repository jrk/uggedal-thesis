...
\begin{itemize}
  \item \term{social navigation} is the concept of our main topic.
  \item \term{collaborative filtering} is often used to realize our
    main topic.
  \item \term{recommender system} can be an application of our main topic.
  \item \term{tagging} can be related to our topic depending on use.
\end{itemize}
...
to what he calls \val{the Graph} (GGG: Giant Global Graph) in a
...
This distinction is grounded in the nature of the exchange of information
between the two parties involved in a social navigation process: the advice
...
extension%
\sidenote{
  Specifically \project{Greasemonkey}, an extension allowing for
...
programming language. \project{Hoodwink.d}, as it's called, is underground in
the sence that it's quite hard to get in to the community. It's members rarely
talk about Hoodwink.d publicly, baring similarities to the underground fight
club in the motion picture aptly named \work{Fight Club}%
\sidenote{
  A quote from the movie clearly
