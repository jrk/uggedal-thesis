...
and relating to the web. Then we'll concentrace on these two topics together
...
% in computers, etc. Maby cite definition of ``navigate'' in dictionary.
...
\sidenote{
  ...
  \citep[p.~1200]{anderson97}
}
Since then it's been used to describe behaviour related to safely finding ones
way wether one is driving a car, flying a plane or walking on foot. Maps and
compass are often used as aids in this wayfinding. When used in context of
computer systems navigation is essentially a methaphor of our usage of the
...
\sidenote{
  ...
  an aboundance of plugins and extensions for the main stream browsers that
  enable new possibilities for navigation.
}
than the eariest applications we're not concerned with those here.
...
\section{Sociality}
% Discuss briefly sociality in general terms and in relation to computers.
% Define social from a dictionary.
% Sociality is defined as .. .. .. this means that .. .. ..
...
% Discuss sociality on the web. Maby a good place for a Web 2.0 discussion.

Sociality has becom an integral part of our modern web.
...
\begin{quote}
  ...
  activity, a third model of navigation aris\-es. This is \emph{social}
...
% discuss this a bit further based on my short paper
