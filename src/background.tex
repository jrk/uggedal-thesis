...
Therefore we can define navigation on the Web for our purposes as the
...
\term{searching} when we're navigating the Web trough hyperlinks.
...
global\dash{}when navigating the Web with a search oriented mind set.
\citet[\pp{53}{54}]{freyne07} distinguishes between browsing as navigating
...
use of blogs (see \tablepageref{blog.usage} for details)
...
They give merit to tag clouds as a navigational interface since it
...
for enabling efficient navigation.
...
\sidenote[-7]{
  ...
  the tags \emph{comedy}, \emph{romanticcomedey}, and \emph{norwegian} for
...
\begin{figure}
  \begin{whole}
    \centering
    \includegraphics[width=0.9\wholewidth]{scrsh_trailfire_trail}
...
the authors had a strong belief in this being true
...
The distinction between a content-based and collaborative approach lies in
...
\sidenote{
  An American online movie rental company located at
...
dependant on the creator of the web site, but the users of Hoodwink.d
\sideFigHoodwinkd
needs to
