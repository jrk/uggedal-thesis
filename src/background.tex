...
The JavaScript web plattform have been described as
...
dramatically similar to the way an epedemic spreads
\citep[\pp{8}{12}]{gladwell01}.
...
\term{wisdom of crowds}, a phenomena that descibes the ammount of information
contained in a group's collective verdict.
In many situations the crowd is able to hold a complete picture of the world
in their collective breains \citep[\p{11}]{surowiecki04}. The larger the
...
\sidenote{
  ...
  provides. The underlying principle of Google's search algoritm is
...
A wise crowd is characterized by diversity of oppinion, independence,
