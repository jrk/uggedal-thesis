...
\sidenote{
  ...
  to computers and not just humans \citep{bernerslee01}. Although this idea was
  introduced by \citeauthor{bernerslee07} in 1994 it remains largely
...
navigation in general terms while higlighting some implementations of
...
\citet{dieberger97} is particularly concerned with making \emph{URL}%
\sidenote{
  Uniform Resource Locator. URL was formerly an abbreviation of Universal
  Resource Locator.
}
handling transparent for users in different tools related to web browsers and
...
A new phenomena appeared with the introduction of the \emph{del.icio.us} social
bookmarking system. %cite, discuss further, lead in to next section.
