...
of items similar items can then be recommended\dash{}an asocial process.
This means that recommender systems is a broader concept than collaborative
filtering. Collaborative filtering \postquote[\p{241}]{herlocker00}{%
  are based on human and not machine analysis of content}
Recommender systems can be based on either one.
