...
\figureref{scrsh.flickr.tagcloud} shows an example of a tag cloud using
only font sizes for distinguishing amongst tag frequenzy.

\begin{figure}
  \begin{whole}
    \centering
    \includegraphics[width=0.9\wholewidth]{scrsh_tagcrowd_journal_redflavor}
    ...
    \label{figure:scrsh.tagcrowd_journal_redflavor}
  \end{whole}
\end{figure}
