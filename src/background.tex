...
required fewer queries than using the tag clouds \citeyaerpar{\p{24}}.
Another drawback when finding more specific information is that tag clouds
are not as good at narrowing down information \citeyearpar{\p{28}}.
...
the tag cloud is faster than formulating a search query \citeyearpar{\p{27}}.
