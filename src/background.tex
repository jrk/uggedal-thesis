...
After our main survey of social navigation in general terms we'll look at
the various forms of social navigation that researchers have implemented
...
\dash{}makes browsing sometimes effective as a navigation method.
...
\sidenote[3]{
  {API} is short for Application Programming Interface and can be seen as a
...
\subsection{Applied forms of social navigation}
...
value for individuals seeking information trough a folksonomy.
They presented users
...
\citet[\p{1}]{fokker06} argues that social tagging is ideal
...
\begin{figure}
  \includegraphics[width=0.9\textwidth]{scrsh_trailfire_trail}
...
systems. Usage studies showed such explanations increased acceptance of
collaborative filtering systems. Whether explanations improved actual
filtering performance was not certain\dash{}even though
