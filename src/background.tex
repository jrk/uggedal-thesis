...
Some have described Web 2.0 by the various types of applications on the Web
which have been popular
%\citex{\paragraphs{2.10}{2.24}}{beer07}
The theme seems to be that the most dominant classes of applications on the
Web are: wikis, social networking sites, folksonomies, mashups.
