...
New forms of and more alaborate interaction due to technological advances
enables the production of applications on the Web previously only viable
to implement as desktop software \citep[p.~101]{lin07}.
