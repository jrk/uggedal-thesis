...
\abbr{Reddit}\dash{}a web site where people can submit links to everything
...
recommendation engine. We did this to dissect how collaborative filtering
algorithms are used in real applications. The source code of this algorithm
can be found in \sourcecoderef{reddit.cf.algorithm}. What follows is the
algorithm in mathematical notation.

Given $A$ as the time the entry was posted and
$B$ as 7:46:43 a.m. December 8, 2005
we have $t_s$ as their difference in seconds

\begin{align}
  t_s &= A - B \\
  \intertext{and $x$ as the difference between the number of up votes as $U$
             and the number of down votes as $D$}
  x &= U - D \\
  ...
  f(t_s, y, z) &= \log_{10}{z} + \frac{yt}{45000}
\end{align}
