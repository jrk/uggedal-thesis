...
prototype systems with social navigation features. As our focus is on
navigation in web pages we're only interested in \citeauthor{dieberger97}'s
discourse of this particular problem and not his discussion of tool support.
...
\citeauthor{dieberger97} observed the same
