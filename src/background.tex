...
\citet{svensson05} argues that while social navigation is plentifull in
...
translations from our physical world to our virtual world en masse, they
explain that one instead have to
``make information spaces afford social interactions and accumulate
social trails'' \citeyearpar[p.~377]{svensson05}. With \emph{social trails}
the authors mean traces left in the system by past users guiding current
