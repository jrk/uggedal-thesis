...
The behaviour we've described with regards to hypertext usage is known as
browsing. Author describes the characteristics of such navigation well:
...
to make further confinements and not focusing on such behaviour in out thesis.
