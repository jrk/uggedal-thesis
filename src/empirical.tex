...
\begin{items}
  \item How frequently have you used the new functionality when you are
...
Next we wanted to investigate the percieced usefullness of our prototype
implementation:

% reference and descibe questions

% list questions

Lastly we tried to investigate the perceived ease of use for our prototype
implementation:
