...
$t_1$ and placebo $p_1$ obtantion, to successful treatment $t_2$ and placebo
$p_2$ installation, and finally to posttest respondents $t_3$ and $p_3$.

In
\tableref{respondent.profiles} we've summarized key characteristics
of all respondents and the experiment and control groups.
