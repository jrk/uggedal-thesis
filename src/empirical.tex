...
In \tableref{respondent.profiles} we've summarized key characteristics
...
\begin{table}
  ...
  \caption[Characteristics of Respondents]{%
    ...
    \q{always} and \q{regularly} while sporadic is an aggreagation of
    \q{sometimes} and \q{seldom/never}. Similarly often usage of
    \urort{} represents responses with \q{daily}, \q{several times a week},
    and \q{weekly} while sporadic is an aggregation of
    \q{monthly} and \q{seldom/never}.
  }
...
First we compared how frequent respondents with an activity feed kept
up-to-date with those without an activity feed. The results are displayed
in
\tableref{uptodate.favorite.activities.frequency.between}.
