...
% Description of URL structure and it's RESTfulnes:
\sidenote{
...
% /profile.php?id=\var{person-id}
  ...
  % /network.uri (completed in other rev)

    % 1.1.1 Browse My Networks

      % 1.1.1.1 Profile (picture)
      % 1.1.1.2 Profile (person)
      % 1.1.1.3 Network (network)
      % 1.1.1.4 Send Message
      ...
      % /friends/?id=\var{person-id}
        ...
        % 1.1.1.5.1 Profile (picture)
        % 1.1.1.5.2 Profile (person)
