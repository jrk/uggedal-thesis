\chapter{Social Navigation in Modern Web Sites}
...
\sidenote{
  Google Maps can be found at \url{http://maps.google.com}.
...
\sidenote[3]{
  Yahoo! Maps have its home at \url{http://maps.yahoo.com}.
}
...
that are interesting (see \sectionref{analysis.flickr.interestingness}
...
improved \abbr{URL} handling as envisioned by
