...
\begin{enum}
  \iterm{Administrative sections} where users can change their profiles or set
    their preferences.
  \iterm{Help pages} where \abbr{FAQ}s, guides, and instructions are presented in a
    static manner.
...
\begin{enum}
  ...
  \iterm{Page title} as a description of what the page contains. Some of the
    ...
    \sidenote{
      ...
      of the \abbr{HTML} document and the \code{<h1>} top level heading in-line
...
this information. We're not convinced of it's usefulness in light of
...
Since our focus is dissimilar compared to that of most information
...
inventories for such means is as far as we know not conducted before. We're
therefore exploring unknown waters and possibly have to adapt our method as we
go.
