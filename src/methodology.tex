...
truly informing it's recipients about a web site's content \citep{wodtke02}.
...
under investigation. From there the web site was browsed by following all
navigational hyperlinks in logical order (from top to bottom and left to
right) until we had frequented the whole site. We woulden't actualy frequent a
web site in it's entirity--bearing in mind our sampling constraints and
abstractions we frequented the site to full coverage.
We stopped browsing a particular page if it%
\sidenote{
