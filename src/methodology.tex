...
\oddsidenote{
  ...
  As we're only concerned with the navigational parts of web pages we
  opted to only record what we found to be useful for this purpose.
}:
...
patterns of social navigation in web sites. Analysing content inventories for
...
\sidenote{
  ...
  beneficial just because of the resulting documantation one creates of a web
  site. People conducting content inventories tends to get deeply informed
  about a web sites content and structure after having matisiously 
}
