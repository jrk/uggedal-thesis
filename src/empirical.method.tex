...
\begin{figure}
  ...
  \caption[Experiment Overview]{
    Overview of the various parts of the experiment. The sample $n_1$
    ...
    given a posttest.
    $t_3$ of the treatment sample $t_2$ and accordingly $p_3$ of the
    placebo sample $p_2$ completes the posttest.
  }
...
\begin{figure}
  ...
  \caption[Experiment Non-Achievement Rates]{
    ...
    The sample $n_1$ of 789 \urort{} users were given a pretest and
    a sample $n_2$ of 123 completes the pretest.
    By randomization a sample $t_1$ of 35 were given a treatment while
    a sample $p_1$ of 36 were given a placebo.
    The sample $n_2$ were given a follow-up questionnaire for checking
    how the installation of the prototypes went. $n_3$ completed the follow-up
    questionnaire.
    A sample $t_2$ of 25 and a sample $p_2$ of 20 managed to install
    the treatment and placebo prototype respectively.
    Of those a sample $t_3$ of 14 from the treatment sample $t_2$ and
    a sample $p_3$ of 11 from the placebo sample $p_2$ completed
    a posttest.
  }
