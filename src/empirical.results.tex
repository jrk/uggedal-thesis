...
Firstly we compared how easy respondents felt it was to keep up-to-date on
...
Secondly we tested if there was a change in acceptance within the respondent
...
The data shows that the median acceptance rate have risen from the pretest to
the posttest for both experiment and control respondents. The acceptance of
the statement about how easy it is to keep up-to-date on favorites'
...
See
\tableref{uptodate.favorite.perceived.usefulness.between} for the results.
...
\begin{table}
  ...
  \label{table:uptodate.favorite.perceived.usefulness.between}
  \end{whole}
\end{table}
...
See
\tableref{uptodate.favorite.perceived.ease.of.use.between} for the results.
...
\begin{table}
  ...
  \label{table:uptodate.favorite.perceived.ease.of.use.between}
  \end{whole}
\end{table}
...
\tableref{uptodate.standard.feature.between} compares responses between the
...
an activity stream would increase the frequency experiment respondents were
keeping up-to-date.
...
\tableref{uptodate.prototype.frequency.between} lists an comparison
...
having used an activity stream.
...
\begin{table}
  ...
  \label{table:uptodate.favorite.amount.between}
  \end{whole}
\end{table}
...
is summarized in
\tableref{uptodate.favorite.amount.within}.
...
\begin{table}
  ...
  \label{table:uptodate.favorite.amount.within}
  \end{whole}
\end{table}
...
Based on the data we've provided the $H_0$ for the number of favorites related
