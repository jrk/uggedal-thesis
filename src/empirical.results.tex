...
Firstly we compared how easy responents felt it was to keep up-to-date on
...
perceived ability for enabeling respondents to keep up-to-date on more
...
Just as the perceived usefulness statements, these stements were only
...
The acceptance data shows equaly positive results for both groups. There is no
