...
Secondly we compared how easy respondents felt it was to keep up-to-date on
...
control group to the experiment group were statistically significant.
...
% from general easy to keep up-to-date statement
%
...
% from specific easy to keep up-to-date statements
%
...
%%
%% Include frequency the feature was used from posttest here.
%%
