...
%%% write more about JavaScript features as a modern language from pro JavaScript tech.

% list it's good features, and that recently the style of JavaScript has changed. cite
% JavaScript pro book. cite JavaScript ref book.
% cite Steve Yegge about next big language

\subsubsection{Convenience Library}

We decided to use a JavaScript library to make interactions with the DOM
simpler. Lately a myriad of such frameworks have appeared, but the most
...
When doing prototype work it's important that the programming language one uses
