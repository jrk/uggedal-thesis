...
%
% The design is in a way a recommender system or could be made into one
...
solution ensures universal access across browsers and plattforms requiring no
installation of additional browser extensions or plugins. The drawbacks to
such and approach for our prototype is quite clear. A user having enabeled
...
related. This would introduce sustantial loads on our servers and users would
...
% respondents: half should receive bogus client. record their email
% and type of prototype they received

% store slug of every person which makes a request so that the
% cache can be warmed-up at certain intervals

\subsection{Background Processes}

With our cache architecture in place it became apparent that 
