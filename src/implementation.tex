...
small script presented in \sourcecodepageref{javascript.comment.stripping}
...
\begin{scode}{JavaScript}{dom.manipulation.prototype}{%
  \abbrDOM} Manipulation with Prototype}{%
...
\begin{scode}{JavaScript}{dom.manipulation.yui}{%
  \abbrDOM} Manipulation with Yahoo! UI Library}{%
...
\begin{scode}{JavaScript}{dom.manipulation.mootools}{%
  \abbrDOM} Manipulation with MooTools}{%
...
\begin{scode}{JavaScript}{dom.manipulation.mochikit}{%
  \abbrDOM} Manipulation with MochiKit}{%
...
\begin{scode}{JavaScript}{dom.manipulation.jquery}{%
  \abbrDOM} Manipulation with jQuery}{%
