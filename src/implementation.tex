...
is new for the areas that you personaly care about. The main page
as seen in \figureref{scrsh.urort.main.page}
displays the latest editorial articles and in some sence they represent
new content. At the right margin there are also lists of both editorial song
selections and the most popular by listenings and downloads. Wether you're
...
as an aggreagation of all supported services you're using. Both activity feed
aggreagators are shown in \figureref{scrsh.friendfeed.me} and
...
\begin{figure}
  \begin{whole}
    \centering
    \includegraphics[width=0.9\wholewidth]{scrsh_socialthig}
    \caption[Socialthing! Activity Feed]{
      Activity feed for the author and his friends on Socialthing!,
      retrieved May 18, 2008, from
      \url{https://socialthing.com/#&lifestream:0:0:e30=&}.
    }
    \label{figure:scrsh.socialthing}
  \end{whole}
\end{figure}

% aggregation of several users on facebook
%
...
language for querying the server, communiates these queries trough a given
...
hiding away its underlying tecnical system for the client
\citep[\p{79}]{sinha92}.
...
computations on the data before a response is sendt
