...
\sectionref{mplementation.architecture.background.process}); a \code{requests}
column to count the times the respondent requests data from our server; and a
\code{created\_at} column to keep track of when a respondent first registered
his email when downloading our client software.

\tableref{prototype.data.structure} gives details about the data we stored.
