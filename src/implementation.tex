...
This philosoply is closely related to minimalism, a movement where the
...
and changed. \term{Test-driven development} is a development technique
...
% refer to test driven development by example, kent beck

\term{Behaviour-driven development} is a response to the test-driven
