\chapter{Implementation of a Transparent Prototype}
...
chapter, \chapterref{selection.of.third.party.software},
...
display of this information led to concerns \citet[\pp{13}{14}]{boyd08}. 
...
usefulness of activity feeds we decided use such a navigational design in our
...
As described in
\sectionref{methodology.user.experiment}
...
described in \sectionref{implementation.building.on.top.of.the.web}.
