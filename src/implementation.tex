...
\begin{items}
  ...
  \iterm{Blog posts} beein written by the artist.
\end{items}
...
so future concert events are filtered out. Secondly we're showing the most
recent activities believing that fresh content is more important than aged
content.
%%
%% complete
%%
