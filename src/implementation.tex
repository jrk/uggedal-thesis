...
%
% try to say something about how less data makes coises easier
...
\term{seperation of concerns} \citep[p.~61]{dijkstra82}.
...
an impossible feat with monolitic systems \citep[pp.~7--8]{lewandowski98}.
...
it allows us to cache data globally\dash{}shared by all clients. Therefore
data collection is handled on the server side, while data display obviously
