...
Firefox's provide user scripting trough the means of the
...
in various ways using the \term{DOM}%
\sidenote{
  % write from js book.
}.
...
\project{Prototype}%
\sidenote{
  Available at \url{http://www.prototypejs.org}.
},
\project{Yahoo! UI Library}%
\sidenote{
  Available at \url{http://developer.yahoo.com/yui}.
},
\project{MooTools}%
\sidenote{
  Available at \url{http://mootools.net}.
},
\project{MochiKit}%
\sidenote{
  Available at \url{http://mochikit.com}.
}, and
\project{jQuery}%
\sidenote{
  Available at \url{http://jquery.com}.
}.
...
called an \term{integrated development environment}%
\sidenote{
  A good example of an integrated development environment is
  \project{Eclipse} (available at \url{http://eclipse.org}).
