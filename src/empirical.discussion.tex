...
established web site one are prototyping. If this underlying structure changes
the prototype can cease to function properly. The ammount of harm such a
...
\begin{items}
  ...
  \iterm{Client side:} If changes to the underlying web site hinder the client
    ...
    contents, one could be in a world of pain. Regardless of how easy the
...
changes and tried to keep updated of how our prototype functioned at all
