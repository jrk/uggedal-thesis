...
The results of asking in this manner yielded no noticable nor significant
...
navigational posibilities available. The statements of percieved ease of use
...
indidcated a dead race between the prototype with an activity feed and the
...
we got valuable streamback on how well such a system works for the average
user.
