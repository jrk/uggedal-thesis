...
\sidenote{
  See \tableref{uptodate.favorite.activities.within} for details.
}
...
for validating our alternative hypothesis. In addition the comparison within
...
we observed differences between the groups and within the groups%
\sidenote{
  See
}
